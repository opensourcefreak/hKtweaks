...
public class VoltageCam {
    ...
    public static final String BACKUP = "/data/.hKtweaks/busCam_stock_voltage";

    public static final String VOLTAGE = "/sys/class/devfreq/17000040.devfreq_cam/volt_table";
